...
/**
 * @\Doctrine\ORM\Mapping\Entity(repositoryClass="ZlyTemplater\Model\DbTable\Layout")
...
class Layout
{
    ...
    protected $published;
    /**
     * @\Doctrine\ORM\Mapping\ManyToOne(targetEntity="ZlyTemplater\Model\Mapper\Theme")
     * @\Doctrine\ORM\Mapping\JoinColumn(name="theme_id", referencedColumnName="id", unique=false)
     */
    protected $theme;
    /**
     * @\Doctrine\ORM\Mapping\OneToMany(targetEntity="ZlyTemplater\Model\Mapper\Widget", mappedBy="layout", cascade={"remove", "persist"})
     */
    protected $widgets;    
    /**
     * @\Doctrine\ORM\Mapping\OneToMany(targetEntity="ZlyTemplater\Model\Mapper\LayoutPoint", mappedBy="layout", cascade={"remove", "persist"})
     */
    protected $points;
