...
/**
 * @\Doctrine\ORM\Mapping\Entity(repositoryClass="ZlyTemplater\Model\DbTable\Widget")
...
class Widget
{
    ...
    /**
     * @\Doctrine\ORM\Mapping\ManyToOne(targetEntity="ZlyTemplater\Model\Mapper\Layout")
     * @\Doctrine\ORM\Mapping\JoinColumn(name="layout_id", referencedColumnName="id", unique=false)
     */
    protected $layout;
    /**
     * @\Doctrine\ORM\Mapping\OneToMany(targetEntity="ZlyTemplater\Model\Mapper\WidgetPoint", mappedBy="widget", cascade={"remove", "persist"})
     */
    protected $points; 
